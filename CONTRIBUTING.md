...
1. Create the release candidate:
    - Go to the [Prepare release](https://github.com/getindata/kedro-starters/actions?query=workflow%3A%22Prepare+release%22) action.
    - Click "Run workflow"
...
3. Checkout the [Publish](https://github.com/getindata/kedro-starters/actions?query=workflow%3APublish) workflow to see if:
