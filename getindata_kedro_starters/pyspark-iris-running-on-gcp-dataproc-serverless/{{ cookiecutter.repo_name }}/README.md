...
This starter requires a bit of infrastructure in Google Cloud beforehand. In order to do so, install Terrafor and GCloud CLI, and follow these steps:
...
3. Run the job:
        ...
        gcloud dataproc batches submit pyspark file:///home/kedro/src/entrypoint.py \
            ...
            --subnet dataproc-serverless-subnetwork \
            --container-image gcr.io/{{ cookiecutter.gcloud_project }}/kedro-{{ cookiecutter.repo_name }}:latest \
            --version 2.0 \
            --properties spark.dynamicAllocation.maxExecutors=2 -- \
            run --env dataproc-serverless
